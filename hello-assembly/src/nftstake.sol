...
contract DeBoxGuardiansStaking is Ownable {
    ...
    event NFTStaked(address owner, address ca, uint256 tokenId);
    event NFTUnstaked(address owner, address ca, uint256 tokenId);
    ...
    function stake(address ca, uint256 tokenId) public {
        ...
        _stakedCnt[ca]++;
        emit NFTStaked(address ca, uint256 tokenId)
    }
